...
echo -e "$red                      ⫸$ylo  kareem alshafey Hackers$red ⫷$rset"
echo 
# Functions
echo -e "$red                    [virus them with fun]$rset"
echo " "
echo " "
}
baner1(){
...
'
echo " " 
echo -e "$red                       ▶Coded by$grn kareem alshafey$red◀$rset"
echo -e "$red                      ⫸$ylo  kareem Hackers$red ⫷$rset"
echo 
# Functions
echo -e "$red                    [virus them with fun]$rset"
echo " "
...
then
am start -a android.intent.action.VIEW -d https://github.com/kareem68960/virus.git > /dev/null 2>&1
banner
menu
elif [ $optnz = "7" ];
then
...
echo -e "\e[93m             IAM FROM \e[92mkareem alshafey HACKERS" | pv -qL 10
echo -e "\e[93m       IM A \e[92mGEEK\e[93m WITH LOTS OF EXCITEMENT" | pv -qL 10
echo -e "\e[93m            kareem"                                 | pv -qL 10
echo -e "\e[93m         01068960354                             " | pv -qL 10
echo -e "\e[93m              JOIN GROUPS ON \e[92mWHATS' APP" | pv -qL 10
echo -e "\e[93m        MY WEBSITE:\e[92m 01068960354\e[0m" | pv -qL 10
...
vid(){
FILE=$HOME/infect/kareem.alshafey
if [ -f "$FILE" ]; then
pop
else
echo
